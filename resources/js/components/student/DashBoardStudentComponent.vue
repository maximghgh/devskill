            ...
            <div class="container">
                ...
                <section class="offer offer_main">
                    <div class="offer__inner offer__inner_main">
                        <h1>
                            Повышайте свои знания и навыки вместе с Институтом
                            образовательных технологий
                        </h1>
                        <div class="offer__desc">
                            Наши курсы прошли более 15&nbsp;000&nbsp;школьников
                            и студентов.
                        </div>
                        <a
                ...
                <section class="events">
                    <div class="events__inner">
                        <h2 class="event__h2">Встречи<br>И события</h2>
                        <div class="block_events">
                            <div class="block">
                                <div class="card__event">
                                    <div class="imgsss"></div>
                                    <div class="information__events">
                                        <h3 class="title__events">Название мероприятия</h3>
                                        <span class="desc__events">Илья Петрович Романович доктор такой то степени</span>
                                        <div class="info__event">
                                            <span class="date__events">5 Ноября в 18:00</span>
                                            <span class="date__events">3 корпус ИжГТУ</span>
                                        </div>
                                        <span class="date__events">#хэштег #хэштег #хэштег</span>
                                    </div>
                                </div>
                                <div class="card__event">
                                    <div class="imgsss"></div>
                        ...
                        <div class="category__one category__one_back1">
                            <div class="category__one-inner">
                                ...
                                <div class="category__one-info">
                                    <p>
                                        Добро пожаловать в нашу онлайн-платформу
                                        дополнительного образования! Здесь вы
                                        найдёте практические курсы, составленные
                                        экспертами-практиками, чтобы быстро
                                        прокачать навыки и сразу применить их на
                                        работе.
                                    </p>
                                </div>
                            </div>
                ...
                <section class="course" id="course">
                    <div class="events__inner events__inner--cour">
                            <h2 class="event__h2">Курсы</h2>
                            <!-- mobile filter toggle -->
                            <div class="cour_inner">
                                <div class="course__button course__button_active"
                                    @click="toggleSidebar"
                                >
                                    <img
        ...
        <transition name="modal">
            ...
            >
                <div class="modal-content__block modal-close--auth">
                    <button
                        class="modal-close modal-close--auth"
