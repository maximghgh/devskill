                                            ...
                                            <div class="comment__one">
                                                ...
                                                <div class="comment__block">
                                                    ...
                                                    <div class="comment__likes">
                                                      <div class="comment__like comment__like-good" @click="likeComment(comment)">
                                                        <span>
                                                      ...
                                                      <!-- Кнопка "Дизлайк" -->
                                                      <div class="comment__like comment__like-bad" @click="dislikeComment(comment)">
                                                        <span>
                                                          <svg viewBox="0 0 800 800" >
...
watch(selectedChapter, (newChapter) => {
  ...
  if (newChapter && newChapter.content) {
    ...
    if (["text", "task", "terms"].includes(newChapter.type)) {
      ...
      console.log("Глава с видео. Editor.js не нужен, уничтожаем экземпляр.");
      destroyEditor();
    } else {
...
async function loadCourseComments() {
  try {
    const response = await axios.get(`/api/courses/${courseId.value}/comments`);
...
async function submitComment() {
  ...
  try {
    ...
    const response = await axios.post(`/api/courses/${courseId.value}/comments`, payload);
