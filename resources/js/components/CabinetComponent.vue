                    ...
                    <div class="course__content">
                        <div class="course__menu course__menu-persona">
                            ...
                            <div class="course__menu-block">
                                ...
                                <a href="/profile" class="course__menu-one">Личные данные</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="course__content">
                        <div class="course__cards course__cards_personal">
                            ...
                            <div class="course__cards-inner">
                                ...
                                <div v-if="purchasedCourses.length > 0" class="course__cards">
                                    <div
                                    ...
                                    >
                                        ...
                                        <div class="course__card-buttons">
                                            ...
                                            <div class="menu__button">
                                                <a :href="`/content/${course.id}`" class="button button_transparent button_transparent--xl">
                                                    Приступить к курсу
                                                </a>
                                            </div>
                                        </div>
...
onMounted(async () => {
  ...
  if (user.value.id) {
    try {
      const response = await axios.get(`/api/user/${user.value.id}/purchased-courses`)
